...
// - report manager activex installato ma � una versione vecchia (sotto la 2.3)
...
CLASS METHOD dfReportManager:initClass()
   ...
   // simone 20/2/08
   // se l'activeX � vecchio e non supporta la propriet�
   // "defaultPrinter", accedo tramite DLL (metodo vecchio)
   // perch� non posso impostare la stampante da utilizzare
...
METHOD dfReportManager:init(cRepName)
   ...
   // Simone 28/01/2005
   // mantis 0000509: In stampa Report Manager da una macchina dove non � installato report manager si ha sempre un errore a causa 
   ::check()
RETURN self
...
METHOD dfReportManager:print(cRepName, cRepTitle, nRepCopy, cRepFormula, ;
   ...
   BEGIN SEQUENCE
         ...
         // perch� il file %appdata%\reportman.ini viene letto
...
// Funziona ma � meglio gestire la struttura xExp con funzioni in C
...
// imposta alcune propriet� direttamente nel file .rep
