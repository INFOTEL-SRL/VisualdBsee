...
REM Richiede: prompt Alaska Xbase++ 2.00.2598 (xppload nel PATH).

cd /d "%~dp0.."
call "%~dp0set-vdbsee-build-env.bat"
if errorlevel 1 exit /b 1

set "REL=%VDBLIB_MAINDIR%\output\lib200-2598\rel"
...
echo.
echo Avvio gotutto200-2598.bat /DYNAMIC ...
call gotutto200-2598.bat /DYNAMIC
set "RC=!ERRORLEVEL!"
...
if exist "%REL%\log.log" copy /Y "%REL%\log.log" "%SRC%\log-dynamic.txt" >nul
